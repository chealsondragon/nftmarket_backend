...
var collectionfeaturedstorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, 'media/images/collection/featured')
  },
  filename: function (req, file, cb) {
    cb(null, file.originalname)
  }
})
var collectionfeaturedupload = multer({ storage: collectionfeaturedstorage })
...
router.post('/collectionfeatured',collectionfeaturedupload.single('file'),mediaController.uploadImage)
